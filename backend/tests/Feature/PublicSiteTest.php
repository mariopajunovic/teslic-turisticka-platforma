...
class PublicSiteTest extends TestCase
{
    ...
    public static function pages(): array
    {
        return [
            ...
            'dogadjaji' => ['/dogadjaji'],
            'dogadjaj detalj' => ['/dogadjaj/ljetni-festival-teslic-0'],
            'oglasi' => ['/oglasi'],
            'oglas detalj' => ['/oglas/trazi-se-konobar-banja-vrucica-0'],
            'price' => ['/price'],
            'prica detalj' => ['/prica/med-na-borju-prica-porodice-djukic'],
            'mapa' => ['/mapa'],
