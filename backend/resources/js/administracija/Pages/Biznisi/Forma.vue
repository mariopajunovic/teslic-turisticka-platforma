...
import ModeracijaAlert from '../../components/ModeracijaAlert.vue';
...
<template>
    ...
    <div class="space-y-4">
        <ModeracijaAlert base="biznisi" :id="biznis?.id" :status="form.status" :pending="pending" subjekt="vlasnik" />
