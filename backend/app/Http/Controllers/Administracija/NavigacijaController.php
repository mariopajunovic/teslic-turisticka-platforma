...
class NavigacijaController extends Controller
{
    ...
    protected function validated(Request $request): array
    {
        return $request->validate([
            ...
            'target_type' => ['required', Rule::in([MenuItem::CILJ_STRANICA, MenuItem::CILJ_KATEGORIJA, MenuItem::CILJ_VANJSKI, MenuItem::CILJ_GRUPA])],
    ...
    protected function stavka(MenuItem $stavka, int $dubina): array
    {
        ...
        return [
            ...
            'grupa' => $stavka->target_type === MenuItem::CILJ_GRUPA,
            'mrtav' => $url === null && $stavka->target_type !== MenuItem::CILJ_GRUPA,
