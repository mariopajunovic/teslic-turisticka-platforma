...
class PlaceResource extends Resource
{
    ...
    protected static string|UnitEnum|null $navigationGroup = 'Mapa / Lokacije';

    protected static ?string $modelLabel = 'tačka';

    protected static ?string $pluralModelLabel = 'Mapa / lokacije';
